...
function FrameTable({ className, ...props }: React.ComponentProps<"table">) {
  return (
    <div
...
function FrameTableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      className={cn(
...
function FrameTableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      className={cn(
...
function FrameTableCell({ className, ...props }: React.ComponentProps<"td">) {
  return (
    <td
      className={cn(

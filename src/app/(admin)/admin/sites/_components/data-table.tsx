...
export function DataTable() {
  ...
  const tableQuery = useQuery({
    ...orpc.sites.query.queryOptions({ input: queryInput }),
  ...
  const deleteRow = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({
        queryKey: orpc.sites.query.key({ input: queryInput }),
      });
  ...
  React.useEffect(() => {
    siteUpsertSheetEmitter.on("success", tableQuery.refetch);
    return () => {
      siteUpsertSheetEmitter.off("success", tableQuery.refetch);
    };
  }, [tableQuery.refetch]);

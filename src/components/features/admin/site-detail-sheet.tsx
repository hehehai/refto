...
export function SiteDetailSheet() {
  const [status, setStatus] = useAtom(siteDetailSheetAtom);

  const [loading, setLoading] = useState(true);
  const [detailData, setDetailData] = useState<SiteDetailData | null>(null);
...
SiteDetailSheet.displayName = "SiteDetailSheet";

export default SiteDetailSheet;
